package com.joker.core.recycler.util;
...
import static com.joker.core.recycler.constant.ConstantsKt.ITEM_TYPE_NOT_FOUND;
...
public abstract class MultiTypeDelegate<T> {
    ...
    public final int getLayoutId(int viewType) {
        return this.layouts.get(viewType, ITEM_TYPE_NOT_FOUND);
    }
