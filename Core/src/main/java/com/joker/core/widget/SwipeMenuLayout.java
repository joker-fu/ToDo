...
public class SwipeMenuLayout extends ViewGroup {
     ...
     * @return
     */
    public SwipeMenuLayout setDoubleSwipe(boolean doubleSwipe) {
        isDoubleSwipe = doubleSwipe;
        return this;
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            } else if (attr == R.styleable.SwipeMenuLayout_doubleSwipe) {
                isDoubleSwipe = ta.getBoolean(attr, false);
            }
        }
        ta.recycle();
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        //LogUtils.e(TAG, "onLayout() called with: " + "changed = [" + changed + "], l = [" + l + "], entity = [" + entity + "], r = [" + r + "], b = [" + b + "]");
        int childCount = getChildCount();
        ...
        //Log.d(TAG, "onLayout() called with: " + "maxScrollGap = [" + maxScrollGap + "], l = [" + l + "], entity = [" + entity + "], r = [" + r + "], b = [" + b + "]");
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    private Status status = Status.CLOSE;//代表当前是否是展开状态 2016 11 03 add
    ...
    public void smoothExpand() {
        ...
        cancelAnim();
        final int width = isLeftSwipe ? mRightMenuWidths : -mRightMenuWidths;
        mExpandAnim = ValueAnimator.ofInt(getScrollX(), width);
...
/*        mScroller.startScroll(getScrollX(), 0, -getScrollX(), 0);
    ...
    public void scrollTo(int x, int y) {
        ...
        if (onSwipeListener != null) {
            onSwipeListener.onMoving(x, status);
        }
    }
    ...
    public interface OnSwipeListener {
         ...
         * @param scrollX 滚动距离
         */
        void onMoving(int scrollX, Status status);
    }
